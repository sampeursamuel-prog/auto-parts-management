    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo \BASE_PATH; ?>/index.php?action=client_create" class="btn btn-primary btn-sm">
        ...
        <div class="card-body">
            ...
            <?php if (empty($clients)): ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo \BASE_PATH; ?>/index.php?action=client_create" class="btn btn-primary">
                        Ajouter un client
                    </a>
                </div>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="client-row" onclick="window.location='<?php echo \BASE_PATH; ?>/index.php?action=client_show&id=<?php echo $client['id_client']; ?>'">
                                ...
                                <td>
                                    <a href="<?php echo \BASE_PATH; ?>/index.php?action=client_edit&id=<?php echo $client['id_client']; ?>" 
                                       class="btn btn-sm btn-primary" onclick="event.stopPropagation()">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if ($client['est_actif']): ?>
                                    <a href="<?php echo \BASE_PATH; ?>/index.php?action=client_delete&id=<?php echo $client['id_client']; ?>" 
...
function searchClients() {
    ...
    window.location.href = '<?php echo \BASE_PATH; ?>/index.php?action=clients&search=' + encodeURIComponent(search);
}

function resetSearch() {
    window.location.href = '<?php echo \BASE_PATH; ?>/index.php?action=clients';
}
